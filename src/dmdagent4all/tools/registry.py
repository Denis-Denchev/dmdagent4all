...
from dmdagent4all.permissions.models import ToolManifest
from dmdagent4all.tools.base import ToolHandler, ToolRuntimeContext
...
def load_builtin_manifests() -> dict[str, ToolManifest]:
    manifest_root = files("dmdagent4all").joinpath("manifests/tools")
